...
export default async function CommentSection({ postId, likes }: { postId: number; likes: Like[] }) {
  ...
  return (
    <CommentClient comments={comments} session={session} postId={postId} likes={likes} />
  );
}
